...
const StyledElement = styled.div`
  ...
  padding: 8px;
  gap: 8px;
  border: 1px solid ${themes.common.sidebar_navigate_active_icolor};
  border-radius: 8px;

  cursor: pointer;
  box-shadow: 0px 4px 4px 0px ${alpha(hexToRgb(themes.common.sidebar_navigate_active_icolor), 0.25)};
